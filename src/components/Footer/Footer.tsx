...
const Footer = () => {
  return (
    <footer className="bg-gray-900 p-10 font-[sans-serif] tracking-wide">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div className="lg:flex lg:items-center">
          <ul className="flex space-x-6">
            <li>
              <a href="https://www.facebook.com/arinze.meshachekene">
            ...
            <li>
              <a href="https://www.linkedin.com/in/meshach-ekene">
                <svg xmlns="http://www.w3.org/2000/svg" className="fill-gray-300 hover:fill-white w-7 h-7" viewBox="0 0 24 24">
                  <path fill-rule="evenodd"
            ...
            <li>
              <a href="https://twitter.com/ArinzeMeshach">
        ...
        <div>
          ...
          <ul className="space-y-4">
            <li>
              <a href="mailto:meshacharinze@gmail.com" className="text-gray-300 hover:text-white text-sm" >meshacharinze@gmail.com</a>
            </li>
            <li>
              <a href="tel:+2349037766260" className="text-gray-300 hover:text-white text-sm">09037766269</a>
            </li>
            <li>
              <a href="javascript:void(0)" className="text-gray-300 hover:text-white text-sm">Asaba, Nigeria</a>
            </li>
          </ul>
        </div>
      ...
      <p className='text-gray-300 text-sm mt-10'>© Meshach. All rights reserved.
      </p>
    </footer>
  );
};
